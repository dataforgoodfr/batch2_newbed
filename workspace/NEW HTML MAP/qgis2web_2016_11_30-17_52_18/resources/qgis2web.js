...
var onPointerMove = function(evt) {
    ...
    var tags_popups=["Commune","Score","DEPARTEMENT","REGION",'Nom', 'Ville',  'Adresse',  'Note TripAdvisor',  'Etoiles',  'Nombre d\'avis', 
            ...
            for (var i=0; i<currentFeatureKeys.length; i++) {
                if (currentFeatureKeys[i] != 'geometry'&& tags_popups.indexOf(layer.get('fieldAliases')[currentFeatureKeys[i]] )>-1) {
                    ...
                    if (layer.get('fieldLabels')[currentFeatureKeys[i]] == "header label") {
                        popupField += '<strong ALIGN="CENTER">' + layer.get('fieldAliases')[currentFeatureKeys[i]] + ':</strong><br />';
                    }
