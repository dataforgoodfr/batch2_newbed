...
jsonSource_Hotelschambreaveckitchenette.addFeatures(features_Hotelschambreaveckitchenette);cluster_Hotelschambreaveckitchenette = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_Hotelschambreaveckitchenette
});var lyr_Hotelschambreaveckitchenette = new ol.layer.Vector({
                source:cluster_Hotelschambreaveckitchenette, 
...
lyr_CommunesetArrondissements.setVisible(true);lyr_HotelsInternetgratuit.setVisible(true);lyr_HotelsInternetPayant.setVisible(true);lyr_HotelsaccessiblesPMR.setVisible(true);lyr_Hotelfaisantpartiedunechaine.setVisible(true);lyr_HotelsavecFrigoetouMicroondes.setVisible(true);lyr_Hotelschambreaveckitchenette.setVisible(true);lyr_HotelPeuvisitsetmauvaisavis.setVisible(true);lyr_Dpartement.setVisible(true);lyr_Regions.setVisible(true);
...
lyr_CommunesetArrondissements.set('fieldLabels', {'NOM': 'no label', 'SCORE': 'no label', });
